            ...
            <div className="flex items-center justify-center">
              ...
              >
                ...
                <div className="mt-6 flex gap-3">
                  <button className="flex-1 rounded-full text-sm px-8 py-3 bg-amber-500 font-semibold text-white shadow-2xl hover:scale-101 hover:cursor-pointer">Start Challenge</button>
                  <button className="rounded-full px-4 py-2 text-sm border border-white/10 bg-transparent text-slate-200 hover:scale-101 hover:cursor-pointer">View Profile</button>
                </div>
              </motion.div>
            </div>
          </div>
