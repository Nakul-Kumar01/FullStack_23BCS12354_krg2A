...
export default function Header() {
  ...
  return (
    <div className="fixed top-0 left-1/2 -translate-x-1/2 z-50">
      <div className="flex items-center justify-evenly gap-6 px-8 py-1 rounded-bl-2xl rounded-br-2xl shadow-xl backdrop-blur-lg bg-[rgba(253,253,253,0)] border border-white/10">
        <NavLink to="/" >
